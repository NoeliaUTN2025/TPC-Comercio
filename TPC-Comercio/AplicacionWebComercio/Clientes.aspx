<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Clientes.aspx.cs" Inherits="AplicacionWebComercio.Clientes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h2>Gestión de Clientes</h2>

    <asp:Button ID="btnNuevo" runat="server" Text="Nuevo Cliente" OnClick="btnNuevo_Click" CssClass="btn btn-success mb-3" />
    ...
    <asp:Panel ID="pnlFormulario" runat="server" Visible="false" CssClass="card p-3 mb-3">
        ...
        <div class="row">
            <div class="col-md-4 mb-2">
                ...
                <asp:TextBox ID="txtDNI" runat="server" CssClass="form-control" MaxLength="15" />
    ...
    <asp:GridView ID="dgvClientes" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover"
        DataKeyNames="ID" OnRowCommand="dgvClientes_RowCommand" OnRowDeleting="dgvClientes_RowDeleting">
        <Columns>
